...
REGISTER '/home/deepakray/Deepak/acadgild/Assignments/Session5Assignment2/piggybank.jar';

--Load flight details 
flight_data = load '/home/deepakray/Deepak/acadgild/Assignments/Session5Assignment2/DelayedFlights.csv' USING org.apache.pig.piggybank.storage.CSVExcelStorage(',','NO_MULTILINE','UNIX','SKIP_INPUT_HEADER');
...
airport_data = load '/home/deepakray/Deepak/acadgild/Assignments/Session5Assignment2/airports.csv' USING org.apache.pig.piggybank.storage.CSVExcelStorage(',','NO_MULTILINE','UNIX','SKIP_INPUT_HEADER');
